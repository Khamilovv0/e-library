...
@section('content')
    <div class="card">
        <div class="card-header">
            <h3 class="card-title">Добавить вид издания</h3>
        </div>
        <div class="card-body">
            <form action="{{ route('add_edition') }}" method="POST">
                @csrf
                ...
                @foreach($lists as $index => $list)
                    <tr id="list-{{ $list->id }}">
                        ...
                        <td>
                            ...
                            <form action="{{ route('delete_edition', $list->id) }}" method="POST" style="display:inline-block;">
                                @csrf
