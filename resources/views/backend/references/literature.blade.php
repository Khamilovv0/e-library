...
@section('content')
    <div class="card">
        <div class="card-header">
            <h3 class="card-title">Добавить вид литературы</h3>
        </div>
        <div class="card-body">
    ...
    <div class="card mt-4">
        <div class="card-header">
            <h3 class="card-title">Список видов литератур</h3>
        </div>
        <div class="card-body">
                ...
                @foreach($lists as $index => $list)
                    <tr id="list-{{ $list->id }}">
                        ...
                        <td>
                            ...
                            <form action="{{ route('delete_literature', $list->id) }}" method="POST" style="display:inline-block;">
                                @csrf
